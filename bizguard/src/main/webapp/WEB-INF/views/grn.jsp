...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li class="">
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Master Templates</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse" style="height: 0px;">
                    ...
                    <li  > <a href="/#" >Item Packing</a></li>
                    <li  > <a href="/#" >Item Unit</a></li>
                    <li  > <a href="/#" >Bank Details</a></li>
                    <li  > <a href="/#" >Warehouse Details</a></li>
                </ul>
            </li>
            <li class="">
                <a href="<%=request.getContextPath()%>/transaction/grn"><i class="fa fa-sitemap"></i> <span class="nav-label">Transactions</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse" style="height: 0px;">
                    <li > <a href="/#" >Goods Received Note</a></li>
                    <li > <a href="/#"  >Goods Issue/Release Note</a></li>                                        
                    <li > <a href="/#"  >Ledger</a></li>
                </ul>
            </li>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Task</th>
                                    <th>Date</th>
                                    <th><form:select path="country" items="${countryList}" /></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
